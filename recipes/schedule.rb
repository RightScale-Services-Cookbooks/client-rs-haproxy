...
# Run client-rs-haproxy::frontend on given interval.
cron "client-rs-haproxy::frontend" do
  minute "*/#{interval}"
  hour '*'
  command "rs_run_recipe --policy 'client-rs-haproxy::frontend' --name 'client-rs-haproxy::frontend'"
